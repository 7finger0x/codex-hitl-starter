...
**Tests**: Tests are mandatory for behavior, security, policy, contract,
persistence, migration, and integration changes. Documentation-only tasks require
objective inspection or validation evidence.
...
- Use **HUMAN CHECKPOINT** tasks immediately before protected actions. Approval of
  a plan, task list, or another checkpoint never carries over.
...
**Purpose**: Governance, source authority, project initialization, and basic structure

- [ ] T001 Inventory governance, source, working-tree, dependency, and checkpoint state in specs/[feature]/checkpoints/
- [ ] T002 HUMAN CHECKPOINT [ID]: approve the exact protected setup action in specs/[feature]/checkpoints/[id].md
- [ ] T003 Create project structure per implementation plan
- [ ] T004 Initialize [language] project with [framework] dependencies after dependency approval
...
- [ ] TXXX Generate exact-revision traceability and evidence with no mandatory gaps
- [ ] TXXX Verify rollback/forward recovery and every human-checkpoint decision
- [ ] TXXX Produce readiness decision without inferring remote or unavailable evidence
...
5. Request the applicable deployment checkpoint if deployment is in scope
...
- Do not stage, commit, push, publish, or deploy unless the user has authorized
  the exact action and any applicable checkpoint
