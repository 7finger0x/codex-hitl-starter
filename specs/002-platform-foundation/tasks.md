...
- [x] T054 Run the complete foundational contract, migration, RLS, cache, runtime-role, health, telemetry, and legacy-controller gates and retain exact-revision evidence (PF-024, PF-026, PF-029) in `evidence/phases/phase-2-foundation.json`
